				...
				<div class="row-fluid">
					...
					<div class="span3">
						...
						<div class="newslatter">
							<form method="get" action="https://ahmedsaeed.000webhostapp.com/shopfine/page">
	...
	<!-- JS
	================================================== -->
	<script src="<?php echo base_url('assets/store_assets/ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js');?>"></script>
	<script src="<?php echo base_url('assets/store_assets/ajax.googleapis.com/ajax/libs/jqueryui/1.10.1/jquery-ui.min.js');?>"></script>
	<!-- jQuery.Cookie -->
	<script src="<?php echo base_url('assets/store_assets/js/jquery.cookie.js');?>"></script>
	<!-- bootstrap -->
    <script src="<?php echo base_url('assets/store_assets/js/bootstrap.min.js');?>"></script>
    <!-- flexslider -->
    <script src="<?php echo base_url('assets/store_assets/js/jquery.flexslider-min.js');?>"></script>
    <!-- cycle2 -->
    <script src="<?php echo base_url('assets/store_assets/js/jquery.cycle2.min.js');?>"></script>
    <script src="<?php echo base_url('assets/store_assets/js/jquery.cycle2.carousel.min.js');?>"></script>
    <!-- tweets -->
    <script src="<?php echo base_url('assets/store_assets/js/jquery.tweet.js');?>"></script>
    <!-- fancybox -->
    <script src="<?php echo base_url('assets/store_assets/js/fancybox/jquery.fancybox.js');?>"></script>
    <!-- custom function-->
    <script src="<?php echo base_url('assets/store_assets/js/custom.js');?>"></script>
